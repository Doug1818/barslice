class Bar < ActiveRecord::Base
  ...
  attr_accessible :name, :address, :neighborhood, :phone, :website, :hrsranges_attributes, :click_count, :tac_accepted
  attr_accessor :tac_accepted
  ...
  scope :not_hidden, where("hidden != ?", true)
